...
class GithubRunner < Sequel::Model
  ...
  dataset_module do
    ...
    # Metal runners are everywhere that isn't the AWS "alien" location, since
    # a runner can legitimately be placed on any real Ubicloud location
    # (Hetzner, Leaseweb, the dedicated runner pool location, ...), not just
    # one specific one.
